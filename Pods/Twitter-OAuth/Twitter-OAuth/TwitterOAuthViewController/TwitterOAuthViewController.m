...
NSString *client_id = @"MBHhRwJJ82sO4UzYKiqY0UT7j";
NSString *secret = @"k1aAIZLYSVCgD4TmWwOvXi8c3vuiNPKTLwPufxZGIAUqxIGRV8";
NSString *callback = @"http://www.startai.com.cn";
...
- (BOOL)webView:(UIWebView*)webView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    // if (result) {
    NSRange textRange = [[temp lowercaseString] rangeOfString:[@"http://www.startai.com.cn" lowercaseString]];
    ...
    if(textRange.location != NSNotFound){
        ...
        if (verifier) {
            [[NSUserDefaults standardUserDefaults] setObject:verifier forKey:@"TwintterLogin"];
...
//- (void)getUserInfo
//{
//    NSString *verifier = [[NSUserDefaults standardUserDefaults] objectForKey:@"TwintterLogin"];
//    NSURL* accessTokenUrl = [NSURL URLWithString:@"https://api.twitter.com/oauth/access_token"];
//    OAMutableURLRequest* accessTokenRequest = [[OAMutableURLRequest alloc] initWithURL:accessTokenUrl consumer:_consumer token:_requestToken realm:nil signatureProvider:nil];
//    OARequestParameter* verifierParam = [[OARequestParameter alloc] initWithName:@"oauth_verifier" value:verifier];
//    [accessTokenRequest setHTTPMethod:@"POST"];
